 ...
 * @endcode
 */
$settings['hash_salt'] = 'iFdlLnXRX9Hi34Yi1sfaidt8xrDc6d26nf067S2w8ypAoZSlE3ii2ElSGP68Q_-w0qyqZgl3xw';
 ...
 */
$settings['reverse_proxy'] = $_ENV['REVERSE_PROXY'] === "TRUE";
...
$databases['default']['default'] = [
  'database' => getenv('MYSQL_DATABASE') ?: "mentorcanada",
  'driver' => 'mysql',
